...
Ensure that the user will have root privileges by selecting the 'Administrator' check-box. This will add the user to the wheel group. Members of the wheel group can use `sudo` with any command by default.
