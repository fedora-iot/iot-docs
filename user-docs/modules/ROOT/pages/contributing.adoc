...
We primarily communicate by the https://lists.fedoraproject.org/admin/lists/iot.lists.fedoraproject.org/[Fedora IoT mailing list] and the #fedora-iot IRC channel on https://web.libera.chat/?channel=#fedora-iot[Libera.Chat].
